...
const Dashboard = ({ user, onGameBrowse, onMissionSelect }) => {
    ...
    const communityShowcase = React.useMemo(() => {
        ...
        return Array(16).fill(null).map((_, i) => ({
            id: i,
            designer: `Artist${Math.floor(100 + Math.random() * 900)}`,
            game: ['Cyberpunk UI', 'Fantasy HUD', 'Sci-Fi Menu', 'Mobile RPG'][i % 4],
            time: `${Math.floor(2 + Math.random() * 10)}h`,
            badge: ['🏆', '⚡', '🎨'][i % 3],
            ...
            <section className="dashboard-header">
                <div className="dashboard-top-bar">
                    <div className="header-greeting">
                        ...
                        <p className="subtitle">Ready to create some amazing game interfaces today?</p>
                    </div>

                    <div className="header-actions">
                        {/* Live Ticker Panel */}
                        <a href="https://www.gamedesignacademia.com" target="_blank" rel="noopener noreferrer" className="live-ticker-panel">
            ...
            <section className="dashboard-section">
                ...
                <div className="latest-missions-grid">
                    {latestMissions.map(mission => (
                        <div key={mission.id} className="mission-card-small" onClick={() => onMissionSelect && onMissionSelect(mission)}>
